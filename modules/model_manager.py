...
class ModelManager:
    ...
    def load_imagenet_labels(self) -> Dict[int, str]:
        ...
        # If not cached, try to download from the correct URL
        if not labels_path.exists():
            ...
            try:
                ...
                logger.info(f"Downloaded {len(labels_list)} ImageNet labels")
                
            except Exception as e:
                logger.warning(f"Failed to download ImageNet labels: {e}")
                logger.info("Creating comprehensive ImageNet labels")
                self._create_comprehensive_labels(labels_path)
        ...
        try:
            ...
            return self._get_comprehensive_imagenet_labels()
    ...
    def _create_comprehensive_labels(self, filepath: Path):
        """Create a comprehensive set of ImageNet labels."""
        comprehensive_labels = self._get_comprehensive_imagenet_labels()
        
        with open(filepath, 'w') as f:
            for i in range(1000):
                label = comprehensive_labels.get(i, f"class_{i}")
                f.write(f"{label}\n")
    
    def _get_comprehensive_imagenet_labels(self) -> Dict[int, str]:
        """Get a comprehensive set of ImageNet labels."""
        return {
            ...
            255: "Leonberger", 256: "Newfoundland", 257: "Great Pyrenees", 258: "Samoyed", 259: "Pomeranian",
            ...
            490: "chain mail", 491: "chainsaw", 492: "chest", 493: "chiffonier", 494: "chime",
            ...
            645: "maypole", 646: "maze", 647: "measuring cup", 648: "medicine chest", 649: "megalithic",
